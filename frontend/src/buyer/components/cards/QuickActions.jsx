...
import { Search, Users, TrendingUp, Heart, ShoppingBag, MessageSquare } from 'lucide-react';
...
export const QuickActions = () => {
  ...
  const actions = [
    {
      ...
      subtitle: 'Discover fresh produce & grain listings',
      icon: Search,
      to: '/buyer/browse',
    ...
    },
    {
      ...
      subtitle: 'Connect with verified regional growers',
      icon: Users,
      to: '/buyer/farmers',
    ...
    {
      title: 'Market Prices',
      subtitle: 'Live mandi price updates & trends',
      icon: TrendingUp,
      to: '/buyer/market-prices',
      color: 'from-indigo-500/20 to-purple-500/10 text-indigo-400 border-indigo-500/30'
    },
    {
      title: 'Wishlist',
      subtitle: 'View saved bulk crops & produce',
      icon: Heart,
      to: '/buyer/wishlist',
    ...
    {
      title: 'My Orders',
      subtitle: 'Track pending & completed purchases',
      icon: ShoppingBag,
      to: '/buyer/orders',
    ...
    {
      title: 'Community',
      subtitle: 'Discuss trends with experts & trade network',
      icon: MessageSquare,
      to: '/buyer/community',
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-base font-bold text-text font-display">Quick Actions</h3>
