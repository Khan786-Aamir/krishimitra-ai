...
export const Topbar = ({
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    if (globalQuery.trim()) {
      navigate(`/marketplace/browse?search=${encodeURIComponent(globalQuery)}`);
    }
  };
      ...
      <div className="flex items-center gap-3">
        ...
        <form onSubmit={handleSearchSubmit} className="hidden sm:flex relative items-center w-64 md:w-80">
          ...
          <input
            ...
            placeholder="Search crop batches, locations..."
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              <span className="block text-xs font-bold text-white max-w-[100px] truncate">{user?.name || 'Administrator'}</span>
